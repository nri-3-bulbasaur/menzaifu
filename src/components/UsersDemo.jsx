          ...
          <TableBody>
            {users.map((user) => (
              <TableRow key={user.id}>
                <TableCell key={user.userId + 'userId'}>
                  {user.userId}
                </TableCell>
                <TableCell key={user.height + 'height'}>
                  {user.height}
                </TableCell>
                <TableCell key={user.weight + 'weight'}>
                  {user.weight}
                </TableCell>
                <TableCell key={user.age + 'age'}>{user.age}</TableCell>
                <TableCell key={user.zaifuPoint + 'zaifuPoint'}>
                  {user.zaifuPoint}
                </TableCell>
                <TableCell key={user.createdAt + 'createdAt'}>
                  {user.createdAt}
                </TableCell>
                <TableCell key={user.updatedAt + 'updatedAt'}>
                  {user.updatedAt}
                </TableCell>
                <TableCell key={user.id + 'delete'}>
                  <Button
                    key={user.id + 'deleteButton'}
          ...
          <TableBody>
            {users.map((user) => (
              <TableRow key={user.id + 'update'}>
                <TableCell key={user.userId + 'userIdUpdate'}>
                  {user.userId}
                </TableCell>
                <TableCell key={user.height + 'heightUpdate'}>
                  {user.height}
                </TableCell>
                <TableCell key={user.weight + 'weightUpdate'}>
                  {user.weight}
                </TableCell>
                <TableCell key={user.age + 'ageUpdate'}>{user.age}</TableCell>
                <TableCell key={user.zaifuPoint + 'zaifuPointUpdate'}>
                  {user.zaifuPoint}
                </TableCell>
                <TableCell key={user.createdAt + 'createdAtUpdate'}>
                  {user.createdAt}
                </TableCell>
                <TableCell key={user.updatedAt + 'updatedAtUpdate'}>
                  {user.updatedAt}
                </TableCell>
                <TableCell key={user.id + 'update'}>
                  <Button
                    key={user.id + 'updateButton'}
